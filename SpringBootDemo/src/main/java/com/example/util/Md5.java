...
public class Md5 {
     ...
     */  
//    public String md5HashCode(String filePath) throws FileNotFoundException{    
...
//    }    
     ...
     * @throws FileNotFoundException 
     */  
//    public String md5HashCode32(String filePath) throws FileNotFoundException{    
//        FileInputStream fis = new FileInputStream(filePath);    
...
//    }    
     ...
     * @return 
     */  
    public String md5HashCode(byte[] fileByte) {    
        try {    
...
//            fis.close();  
     ...
     * @return 
     */  
    public String md5HashCode32(byte[] fileByte) {  
        try {  
            //拿到一个MD5转换器,如果想使用SHA-1或SHA-256，则传入SHA-1,SHA-256    
            MessageDigest md = MessageDigest.getInstance("MD5");  
